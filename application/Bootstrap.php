...
//             }
    ...
    private function initAPIRouter(){
        ...
        $frontController->getRouter()->addRoute('v1/trades/lawyerlisttrade',
        		new Zend_Controller_Router_Route('v1/trades/lawyerlisttrade',array("module"=>"v1","controller"=>"trades","action"=>"lawyerlisttrade")));
        $frontController->getRouter()->addRoute('v1/trades/userlisttrade',
        		new Zend_Controller_Router_Route('v1/trades/userlisttrade',array("module"=>"v1","controller"=>"trades","action"=>"userlisttrade")));
        
        $frontController->getRouter()->addRoute('v1/trades/agree',
        		new Zend_Controller_Router_Route('v1/trades/agree',array("module"=>"v1","controller"=>"trades","action"=>"agree")));        
        $frontController->getRouter()->addRoute('v1/trades/reject',
        		new Zend_Controller_Router_Route('v1/trades/reject',array("module"=>"v1","controller"=>"trades","action"=>"reject")));
        $frontController->getRouter()->addRoute('v1/trades/listremarkbylawyer',
        		new Zend_Controller_Router_Route('v1/trades/listremarkbylawyer',array("module"=>"v1","controller"=>"trades","action"=>"listremarkbylawyer")));
        $frontController->getRouter()->addRoute('v1/trades/remark',
        		new Zend_Controller_Router_Route('v1/trades/remark',array("module"=>"v1","controller"=>"trades","action"=>"remark")));
        ...
        $frontController->getRouter()->addRoute('v1/notifications/readack',
        		new Zend_Controller_Router_Route('v1/notifications/readack',array("module"=>"v1","controller"=>"notifications","action"=>"readack")));
        $frontController->getRouter()->addRoute('v1/notifications/countunread',
        		new Zend_Controller_Router_Route('v1/notifications/countunread',array("module"=>"v1","controller"=>"notifications","action"=>"countunread")));
        $frontController->getRouter()->addRoute('v1/push/push',
        		new Zend_Controller_Router_Route('v1/push/push',array("module"=>"v1","controller"=>"push","action"=>"push")));
    }
...
//         		new Zend_Controller_Router_Route('dashboard/login',array("controller"=>"dashboard","action"=>"login")));
        ...
        $frontController->getRouter()->addRoute('admin/listadmin',
        		new Zend_Controller_Router_Route('admin/listadmin',array("controller"=>"admin","action"=>"listadmin")));
        $frontController->getRouter()->addRoute('admin/deleteadmin',
        		new Zend_Controller_Router_Route('admin/deleteadmin',array("controller"=>"admin","action"=>"deleteadmin")));
        ...
        $frontController->getRouter()->addRoute('trade/agree',
        		new Zend_Controller_Router_Route('trade/agree',array("controller"=>"trade","action"=>"agree")));
        $frontController->getRouter()->addRoute('trade/reject',
        		new Zend_Controller_Router_Route('trade/reject',array("controller"=>"trade","action"=>"reject")));
        $frontController->getRouter()->addRoute('trade/listwaitreviewtrades',
        		new Zend_Controller_Router_Route('trade/listwaitreviewtrades',array("controller"=>"trade","action"=>"listwaitreviewtrades")));
        $frontController->getRouter()->addRoute('systemprocess/reviewtrade',
        		new Zend_Controller_Router_Route('systemprocess/reviewtrade',array("controller"=>"systemprocess","action"=>"reviewtrade")));
        $frontController->getRouter()->addRoute('systemmsg/broadcast',
        		new Zend_Controller_Router_Route('systemmsg/broadcast',array("controller"=>"systemmsg","action"=>"broadcast")));
