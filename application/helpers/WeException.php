	...
	public function getErrorMessage() {
		...
		switch ($this->errCode) {
			...
			case 20260 :
				...
				break;
			case 20261 :
				$this->errMessage = "抢答失败，原因是您已经完成了对该问题的抢答";
				break;
			case 20262 :
			...
			case 20263 :
				...
				break;
			case 20264 :
				$this->errMessage = "您正在抢答另一个问题，不能同时抢答两个问题哦";
				break;
			case 20265 :
				$this->errMessage = "还未进入抢答，不能提交抢答内容";
				break;
			case 20266 :
				$this->errMessage = "回复身份类型不合法";
				break;
			case 20267 :
				$this->errMessage = "回复行为不合法";
				break;
			case 20268 :
				$this->errMessage = "回复内容不能为空";
				break;
			case 20269 :
				$this->errMessage = "没有抢答成功该问题，不能进行回复";
				break;
			case 20270 :
				$this->errMessage = "不能自己回复自己";
				break;
			case 20271 :
				$this->errMessage = "无权限查看该问题的评论";
				break;
			case 20272 :
				$this->errMessage = "委托主题不能为空";
				break;
			case 20273 :
				$this->errMessage = "该发票号已存在";
				break;
			case 20274 :
				$this->errMessage = "必须上传发票号";
				break;
			case 20275 :
				$this->errMessage = "创建委托确认信息不完整";
				break;
			case 20276 :
				$this->errMessage = "委托金额不能为0";
				break;
			case 20277 :
				$this->errMessage = "你无权操作该委托";
				break;
			case 20278 :
				$this->errMessage = "委托状态错误";
				break;
			case 20279 :
				$this->errMessage = "评价内容过短";
				break;
			case 20280 :
				$this->errMessage = "评价委托信息不完整";
				break;
			case 20281 :
				$this->errMessage = "该项委托不存在";
				break;
		    //203XX:chat
