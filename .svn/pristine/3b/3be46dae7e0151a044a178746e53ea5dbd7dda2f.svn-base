...
class CommonHelper
{
	...
	//Object 转array
    	...
    	static function curl_post_async_form($url, $form)
    	{
...
//     }
    ...
    static public function sendlawyer($message, $deviceToken, $badge,$isTest){
    	if($isTest){
    		$serverUrl   = 'ssl://gateway.sandbox.push.apple.com:2195';
    		$apnsCert = APPLICATION_PATH.DIRECTORY_SEPARATOR.'configs'.DIRECTORY_SEPARATOR.'cklawyerdev.pem';
    	}
    	else{
    		$serverUrl = 'ssl://gateway.push.apple.com:2195';
    		$apnsCert = APPLICATION_PATH.DIRECTORY_SEPARATOR.'configs'.DIRECTORY_SEPARATOR.'cklawyer.pem';
    	}
